...
# 2011年の情報を削除
data1 = data1.drop(data1.index[1532:1836])
teacher = teacher.drop(teacher.index[1532:1836])
...
def _get_data():
    ...
    data["stadium_cap"] = data["stadium_cap"].replace(_get_stadium_cap())
    data = data.replace(_get_holiday())
